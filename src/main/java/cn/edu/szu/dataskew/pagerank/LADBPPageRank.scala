...
object LADBPPageRank {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 使用自定义分区器
    val partitioner: RoundRobinPartitioner[String, String] = new RoundRobinPartitioner[String, String](numReducers, links)
