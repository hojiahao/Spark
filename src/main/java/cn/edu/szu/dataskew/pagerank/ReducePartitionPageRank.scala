...
object ReducePartitionPageRank {
  def main(args: Array[String]): Unit = {
    ...
    val sparkConf = new SparkConf()
      .setMaster("yarn")
      .setAppName("ReducePartitionPageRank")
    ...
    // 使用自定义分区器
    val partitioner: ReducePartitioner[String, String] = new ReducePartitioner[String, String](parallel, samplingRate)
    partitioner.initialize(links)
