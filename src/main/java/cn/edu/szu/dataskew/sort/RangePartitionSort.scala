...
object RangePartitionSort {
  ...
  def main(args: Array[String]): Unit = {
    val map_parallelism = 400
    // 创建SparkConf对象并设置配置
    val sparkConf = new SparkConf()
      .setMaster("local[*]")
      .setAppName("RangePartitionSort")
//      .set("spark.submit.deployMode", "cluster")
    ...
    val filepath = "D:\\ResearchWorks\\dataSkewOptimization\\input\\zip-f\\skewness_0.1.txt"
    ...
    val partitioner: RangePartitioner[String, Int] = new RangePartitioner[String, Int](parallel, wordToOne)
